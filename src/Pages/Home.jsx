...
function Home() {
  ...
  return (
    <>
      ...
      <div
        style={{ width: "100%", height: "75vh", backgroundColor: "#040E31" }}
        ...
        <Row className="align-items-center p-5">
          <Col sm={12} md={6}>
            ...
            <p>
              ...
              unde fugiat nostrum totam cumque officiis iure rerum assumenda
              alias delectus possimus neque nihil minus, accusantium omnis
              suscipit non ex voluptate. Distinctio sit officiis voluptates
              doloremque obcaecati? Nobis nihil ipsa, repellendus expedita
              accusamus asperiores incidunt enim veritatis dolor ducimus ut ea
              architecto, perspiciatis sunt, debitis quae molestias officiis
              reprehenderit cupiditate odio?
            </p>
